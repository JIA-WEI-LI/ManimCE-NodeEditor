...
logging.getLogger("node_editor.node_editor_window.core.edge").setLevel(logging.DEBUG)
logging.getLogger("node_editor.node_editor_window.core.node").setLevel(logging.DEBUG)
logging.getLogger("node_editor.node_editor_window.core.scene").setLevel(logging.DEBUG)
logging.getLogger("node_editor.node_editor_window.core.scene_clipboard").setLevel(logging.INFO)
...
logging.getLogger("node_editor.node_editor_window.graphics.graphics_scene").setLevel(logging.DEBUG)
logging.getLogger("node_editor.node_editor_window.graphics.graphics_socket").setLevel(logging.INFO)
logging.getLogger("node_editor.node_editor_window.graphics.graphics_view").setLevel(logging.DEBUG)
